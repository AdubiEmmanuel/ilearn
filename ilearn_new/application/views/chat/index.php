  ...
  <tr>
    ...
    <td>
      <?php
        ...
        if ($video == 0) {
            echo '<input type="submit" name="submit_video" value="Use Camera"
              class="btn btn-info btn-sm" />';
        } else {
            echo '<input type="submit" name="submit_close_video" value="Close Camera"
              class="btn btn-danger btn-sm" />';
        }

        if ($audio == 0) {
            echo ' <input type="submit" name="submit_audio" value="Use Voice"
              class="btn btn-info btn-sm" />';
        } else {
            echo ' <input type="submit" name="submit_close_audio" value="Voice cover"
              class="btn btn-danger btn-sm" />';
        }
      ?>
